package com.techar.EntryPointBackend.config.security.components;
...
public class JwtService {
    ...
    public String refreshToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return buildToken(extraClaims, userDetails, refreshExpirationToken);
    }


    public String buildToken(Map<String, Object> extraClaims, UserDetails userDetails, long expirationToken) {
        return Jwts
                .builder()
